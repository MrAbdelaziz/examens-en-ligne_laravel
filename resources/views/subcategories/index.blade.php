                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('subcategory.create') }}" class="btn btn-sm btn-primary">{{ __('Add subcategory') }}</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <!-- Edit -->
                                                    <a class="dropdown-item" href="{{ route('subcategory.edit', $categ) }}">{{ __('Edit') }}</a>
                                                    <!-- Delete -->
                                                    <form action="{{ route('subcategory.destroy', $categ) }}" method="post">
                                                        @csrf
                                                        @method('delete')
