                        ...
                        <form method="post" action="{{ route('category.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('icon') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="icon" id="input-icon" class="form-control form-control-alternative{{ $errors->has('icon') ? ' is-invalid' : '' }}" placeholder="{{ __('Icon') }}" value="{{ old('icon') }}" required autofocus>
                                    @if ($errors->has('icon'))
                                        <span class="invalid-feedback" role="alert">
