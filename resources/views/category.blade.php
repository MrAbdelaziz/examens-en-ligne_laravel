        ...
        <div id="main-container" class="container">
            <form name="search" method="get" class="product-search-form" id="product-search-form">
                <div class="search-container">
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 style="margin: 0px 0px 35px 0px !important;"><?php echo '<span style="color:#5e72e4">Category : </span>' . App\Http\Controllers\PublicController::getcategoryname($catid); ?></h3>
                                ...
                                <div class="collapse navbar-collapse">
                                    <div class="collapse" id="search-mobile-collapse">
                                        <ul class="nav navbar-nav" style="display:inline;width:100%;padding: 10px;font-size: 15px;letter-spacing: .5px;font-weight: bold;text-transform: uppercase;">
                                            <div class="row">
                                                <div class="col-md-4" style="border:0px;border-right:1px solid #eeeeee;">
                                                    <li class="dropdown" id="search_locale-dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                                            <span style="line-height:30px;">Category</span>
                                                        </a>
                                                ...
                                                <div class="col-md-4" style="border:0px;border-right:1px solid #eeeeee;">
                                                    <li class="dropdown" id="search_locale-dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                                            <span style="line-height:30px;">Subcategory</span>
                                                        </a>
                                                        <div class="dropdown-menu">
                                                            <ul data-simplebar="">
