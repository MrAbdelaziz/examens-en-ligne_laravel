...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('landing') }}/styles/blog_single.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('landing') }}/styles/blog_single_responsive.css">
</head>
<body>
	...
	<script src="{{ asset('landing') }}/js/blog_single.js"></script>
</body>
</html>